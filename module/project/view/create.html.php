  ...
  <div class='center-block'>
    ...
    <form class='form-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          <th><?php echo $lang->project->price;?></th>
          <td><?php echo html::input('price', $price, "class='form-control' required");?></td><td></td><td></td>
        </tr>

        <tr>
          <th><?php echo $lang->project->usedPrice;?></th>
          <td><?php echo html::input('usedPrice', $usedPrice, "class='form-control' required");?></td><td></td><td></td>
        </tr>
...
<!--        </tr>-->
        ...
        <tr>
          <th><?php echo $lang->project->checkdesc;?></th>
          <td colspan='3'>
            <?php echo $this->fetch('user', 'ajaxPrintTemplates', 'type=project&link=desc');?>
            <?php echo html::textarea('checkdesc', '', "rows='6' class='form-control kindeditor' hidefocus='true'");?>
          </td>
        </tr>
        <tr>
